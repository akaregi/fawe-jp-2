...
誤記の訂正や改善点の意見を歓迎いたします。意見は [GitHub](https://github.com/akaregi/fawe-jp) の Issue / Pull request で受け付けています。
...
- この説明書は[公式の Wiki のコマンドページ](https://intellectualsites.github.io/fastasyncworldedit-documentation/basic-commands/main-commands-and-permissions.html/)を参考にしている。
